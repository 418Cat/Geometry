package dev._418cat.math.geometry.angle.angle3d.xyz_angle;

import dev._418cat.math.geometry.angle.angle2d.Angle;
import dev._418cat.math.geometry.vectors.*;
...
public class XYZAngle
{
	...
	public static double[] angle(Vector3D vect1, Vector3D vect2)
	{
		...
		Vector2D[][] axisVectors = new Vector2D[][] {
			{ new Vector2D(vect1.y, vect1.z), new Vector2D(vect2.y, vect2.z) },
			{ new Vector2D(vect1.x, vect1.z), new Vector2D(vect2.x, vect2.z) },
			{ new Vector2D(vect1.x, vect1.y), new Vector2D(vect2.x, vect2.y) } };
	...
	{
		double[] angles = new double[] { Angle.angle(new Vector2D(vect.y, vect.z), new Vector2D(1, 0)),
