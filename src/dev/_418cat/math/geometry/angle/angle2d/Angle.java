...
/**
 * Static tool used to calculate an angle between two objects. From 0 to 360
 * degrees.
 * 
 * @author 418cat
 */
public class Angle
{
	 ...
	 * C point. Forming BAC with A as the angle point.
	 * 
	 ...
	 * the angle point. They don't need to touch.
	 * 
	 * @param AB
	 * @param AC
	 * @return BAC angle
