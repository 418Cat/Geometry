package dev._418cat.math.geometry.angle.angle2d;
...
public class AbsAngle
{
	...
	/**
	 * This function doesn't really make sense as the angle formed by a line and a
	 * point is either 90 or 0. It computes the angle formed by
	 * {@link dev._418cat.math.geometry.lines.Line2D Line}'s point variable
	 * transformed by its vector and this point </br>
	 * <h1>Make sure it's the right use case before calling this function</h1></br>
	 * 
	 * @param line
	 * @param point
	 * @return the angle formed by the line's point variable transformed by its
	 *         vector, the point parameter and the line's point variable as the
	 *         angle point
	 */
	...
	/**
	 * Computes the angle formed by the segment's B point, segment's A point and the
	 * C point. Forming BAC with A as the angle point. From 0 to 180 degrees.
	 * 
	...
	/**
	 * Computes the angle formed by two segments, the two segments' first point as
	 * the angle point. They don't need to touch. From 0 to 180 degrees.
	 * 
	 * @param AB
	 * @param AC
	 * @return BAC angle
	...
	/**
	 * Computes the angle formed by a segment and a vector, and its first point
	 * transformed by the vector AC. From 0 to 180 degrees.
	 * 
	 * @param AB
	 * @param AC
	 * @return BAC angle
	...
	/**
	 * Computes the angle of a vector compared to a (1, 0) vector. From 0 to 180
	 * degrees.
	 * 
	 * @param vect
	...
	/**
	 * Computes the angle of a line compared to a (1, 0) vector. From 0 to 180
	 * degrees.
	 * 
	 * @param line
	...
	/**
	 * Computes the angle of a segments compared to a (1, 0) vector. From 0 to 180
	 * degrees.
	 * 
	 * @param seg
	...
	/**
	 * Computes the angle of a ray and a point. The ray's origin being the angle
	 * point. From 0 to 180 degrees.
	 * 
	 * @param ray
	 * @param pnt
	 * @return angle
